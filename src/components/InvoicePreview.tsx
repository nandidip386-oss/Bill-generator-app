  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 dark:bg-slate-950 print:bg-white print:p-0">
      ...
      <div className="overflow-x-auto pb-8 print:pb-0 print:overflow-visible">
        <div id="printable-invoice" className="a4-container mx-auto bg-white shadow-2xl text-black relative p-[10mm] font-sans flex flex-col print:shadow-none print:m-0 print:w-[210mm] print:h-[287mm] print:min-h-0 print:max-w-none">
